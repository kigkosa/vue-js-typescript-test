...
<div class="flex flex-col h-screen">
      ...
      <header class="bg-white shadow">
        <div class="flex items-center justify-between py-4 md:py-8 mx-auto container">
          ...
          <nav class="hidden gap-12 lg:flex">
            ...
            <a
              href="{{ url('sdasdas') }}"
              class="text-lg font-semibold text-gray-600 transition duration-100 hover:animate-text hover:bg-gradient-to-r from-teal-500 hover:via-purple-500 hover:to-orange-500 hover:bg-clip-text hover:text-transparent hover:font-black active:text-indigo-700"
              >Stock WS / RS</a
            >
            <a href="{{ url('about') }}" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-700"
              target="_self"
              >Tentang</a>
          </nav>
          <!-- nav - end -->
          ...
          <!-- buttons - start -->
          <a
            href="https://helpdesk.aryanoble.co.id/"
            class="hidden rounded-lg bg-gray-200 px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-500 hover:text-white active:text-indigo-100 focus-visible:ring active:text-gray-700 md:text-base lg:inline-block"
            target="_blank"
            >Contact IT</a
          >
      ...
      <section class="container mx-auto flex items-center justify-between lg:flex-row flex-col flex-grow gap-x-12">
        <!-- content - start -->
        ...
        <div class="container mx-auto px-4 flex flex-col items-center justify-between gap-10 pt-8 lg:flex-row lg:gap-8">
          ...
          <div class="flex items-center justify-center gap-4 lg:justify-start">
            ...
            <div class="flex gap-4">
              ...
              <a
                href="{{ url('https://github.com/muchfahmiarif/andev-dashboard') }}"
                target="_blank"
